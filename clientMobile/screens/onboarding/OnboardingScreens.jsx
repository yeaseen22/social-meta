            ...
            >
                <View style={styles.darkSheet}>
                    ...
                    <View style={styles.View2}>
                        ...
                        <View>
                            <Text style={styles.Description}>
                                Share Your Moments & Feelings to Other. And Stay Happy with Our Social Meta
                            </Text>
                        </View>
                    </View>
                </View>
        ...
        <View style={styles.container}>
            ...
            >
                <View style={styles.darkSheet}>
                    ...
                    <View style={styles.View2}>
                        <Text style={styles.Training}>High Secure Messaging</Text>

                        <View>
                            <Text style={styles.Description}>
                                We Provides the Best Secure Messaging without Having any Risks and Doubts.
                            </Text>
                        </View>
                    </View>
                </View>
